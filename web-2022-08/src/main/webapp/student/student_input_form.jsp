...
<html>
	<head>
		...
		<link rel = 'stylesheet' href = './css/student_input_form.css'>
		<script defer src='js/student_input_form.js'></script>
	...
	<jsp:setProperty property = "*" name = "pageVo"/>
		...
		<form id = "student_input_form" name = 'frm_input' method = 'post'>
			<h2>학생정보 입력</h2>
			<div>
